...
},{"../public/vendor/react":5,"./monsterForm":2,"./monsterList":4}],2:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
...
var MonsterForm = React.createClass({displayName: 'MonsterForm',
    ...
    return (
      React.DOM.form( {onSubmit:this.handleSubmit}, 
        React.DOM.div( {className:"form-group"}, 
          ...
          React.DOM.input( {className:"form-control", type:"text", name:"name", ref:"name", id:"name"} )
        ),

        React.DOM.div( {className:"form-group"}, 
          React.DOM.label( {htmlFor:"hp"}, "HP"),
          React.DOM.input( {className:"form-control", type:"text", name:"hp", ref:"hp", id:"hp"} )
        ),
        React.DOM.div( {className:"form-group"}, 
          React.DOM.label( {htmlFor:"ac"}, "AC"),
          React.DOM.input( {className:"form-control", type:"text", name:"ac", ref:"ac", id:"ac"} )
        ),

        React.DOM.div( {className:"form-group"}, 
          React.DOM.label( {htmlFor:"damage"}, "Hit Damage"),
          React.DOM.input( {className:"form-control", type:"text", name:"damage", ref:"damage", id:"damage"} )
        ),

        React.DOM.button( {type:"submit", className:"btn btn-primary " }, "Create")
      )
    );
  }
});
...
},{"../public/vendor/react":5}],3:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
...
var MonsterList = React.createClass({displayName: 'MonsterList',
  render: function() {

    return (
      React.DOM.li( {className:"monster"}, 
        React.DOM.h3( {className:"monster-name"}, this.props.name),
        React.DOM.div( {className:"monster-stats"}, 
          React.DOM.div( {className:"monster-hp stat"}, 
            React.DOM.h4(null, "HP"),
            React.DOM.p(null, this.props.hp)
          ),
          React.DOM.div( {className:"monster-ac stat"}, 
            React.DOM.h4(null, "AC"),
            React.DOM.p(null, this.props.ac)
          ),
          React.DOM.div( {className:"monster-damage stat"}, 
            React.DOM.h4(null, "Damage"),
            React.DOM.p(null, this.props.damage)
          )
        )
      )
    );
...
},{"../public/vendor/react":5}],4:[function(require,module,exports){
/**
 * @jsx React.DOM
 */
...
var MonsterList = React.createClass({displayName: 'MonsterList',
  ...
  render: function () {
    ...
    return (
      React.DOM.div( {className:"monster-list"}, 
        React.DOM.p(null, this.props.monsters.length, " monster(s) left"),
        React.DOM.ul(null, 
          monsterNodes
        )
      )
...
},{"../public/vendor/react":5,"./monsterItem":3}],5:[function(require,module,exports){
(function (global){
/**
 * React v0.10.0
 */
